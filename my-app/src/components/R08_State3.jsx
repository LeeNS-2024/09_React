...
// 자식 -> 부모에게 값 전달하는 방법 (상태 끌어올리기)

/* 자식 컴포넌트 */
// props : 부모로부터 전달받은 값이 담겨있는 객체
const ChildId = (props) => {
  ...
  return(
    <div className='wrapper'>
      <label htmlFor="inputId">ID : </label> {/* htmlFor == html에서 사용하는 for 속성 */}
...
const ParentComponent = () => {
  ...
  const [id, setId] = useState(''); // 초기값 빈 칸
  const [pw, setPw] = useState(''); // 초기값 빈 칸
  ...
  return(
    <>
      ...
      <div className='wrapper'>
        {/* id, pw 중 하나라도 입력 안되면 버튼 비활성화 상태 */}
        <button 
